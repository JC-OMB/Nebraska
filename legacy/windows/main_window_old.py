...
class MainWindow:
    ...
    def setup_ui(self):
        ...
        self.dataset_selection = ttk.Combobox(self.data_frame, state="readonly",
                                              postcommand=self.update_dataset_selection)
        self.dataset_selection.pack()
        self.dataset_selection.bind("<<ComboboxSelected>>", self.on_dataset_selected)

        self.visualize_button_viz = tk.Button(self.visualization_frame, text="Visualizar Datos",
        ...
        self.export_metadata_button = tk.Button(self.export_frame, text="Exportar Metadatos",
